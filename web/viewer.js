...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      editorUndoButton: document.getElementById("editorUndo"),
      editorRedoButton: document.getElementById("editorRedo"),
    },
    secondaryToolbar: {
      ...
      printFileButton: document.getElementById("printFile"),
      sharePdfButton: document.getElementById("sharePdf"),
      shareAsImgButton: document.getElementById("shareAsImg"),
    ...
    annotationEditorParams: {
      ...
      editorStampAddSign: document.getElementById("editorStampAddSign"),
      editorStampAddWatermark: document.getElementById("editorStampAddWatermark"),
