...
pdfjs-editor-stamp-add-sign-button-label = Agregar firma
pdfjs-editor-stamp-add-watermark-button-label = Agregar marca de agua
pdfjs-editor-stamp-add-signature-button-label = Agregar nueva firma
...
pdfjs-share-pdf-button-label = Compartir
pdfjs-share-as-img-button-label = Compartir como imagen
pdfjs-more-button-label = Más