...
pdfjs-editor-stamp-add-sign-button-label = Добавить подпись
pdfjs-editor-stamp-add-watermark-button-label = Добавить водяной знак
pdfjs-editor-stamp-add-signature-button-label = Добавить новую подпись
...
pdfjs-share-pdf-button-label = Поделиться
pdfjs-share-as-img-button-label = Поделиться как изображение
pdfjs-more-button-label = Ещё