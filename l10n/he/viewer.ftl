...
pdfjs-editor-stamp-add-sign-button-label = הוספת חתימה
pdfjs-editor-stamp-add-watermark-button-label = הוספת סימן מים
pdfjs-editor-stamp-add-signature-button-label = הוספת חתימה חדשה
