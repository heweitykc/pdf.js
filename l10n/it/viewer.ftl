...
pdfjs-edit-button-label = Modifica
pdfjs-editor-undo-button-label = Annulla
pdfjs-editor-redo-button-label = Ripristina
pdfjs-editor-insert-button-label = Inserisci
...
pdfjs-editor-stamp-add-sign-button-label = Aggiungi firma
pdfjs-editor-stamp-add-watermark-button-label = Aggiungi filigrana
pdfjs-editor-stamp-add-signature-button-label = Aggiungi nuova firma
...
pdfjs-share-pdf-button-label = Condividi
pdfjs-share-as-img-button-label = Condividi come immagine
pdfjs-more-button-label = Altro