...
pdfjs-editor-stamp-add-sign-button-label = Дадаць подпіс
pdfjs-editor-stamp-add-watermark-button-label = Дадаць вадзяны знак
pdfjs-editor-stamp-add-signature-button-label = Дадаць новы подпіс
