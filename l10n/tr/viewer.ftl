...
pdfjs-editor-stamp-add-sign-button-label = İmza ekle
pdfjs-editor-stamp-add-watermark-button-label = Filigran ekle
pdfjs-editor-stamp-add-signature-button-label = Yeni imza ekle
