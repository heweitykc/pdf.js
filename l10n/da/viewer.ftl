...
pdfjs-editor-stamp-add-sign-button-label = Tilføj underskrift
pdfjs-editor-stamp-add-watermark-button-label = Tilføj vandmærke
pdfjs-editor-stamp-add-signature-button-label = Tilføj ny underskrift
