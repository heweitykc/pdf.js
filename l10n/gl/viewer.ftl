...
pdfjs-editor-stamp-add-sign-button-label = Engadir sinatura
pdfjs-editor-stamp-add-watermark-button-label = Engadir marca de auga
pdfjs-editor-stamp-add-signature-button-label = Engadir nova sinatura
