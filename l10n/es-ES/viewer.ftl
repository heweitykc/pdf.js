...
pdfjs-editor-stamp-add-sign-button-label = Añadir firma
pdfjs-editor-stamp-add-watermark-button-label = Añadir marca de agua
pdfjs-editor-stamp-add-signature-button-label = Añadir nueva firma
