...
pdfjs-editor-stamp-add-sign-button-label = Ajouter une signature
pdfjs-editor-stamp-add-watermark-button-label = Ajouter un filigrane
pdfjs-editor-stamp-add-signature-button-label = Ajouter une nouvelle signature
...
pdfjs-share-pdf-button-label = Partager
pdfjs-share-as-img-button-label = Partager en image
pdfjs-more-button-label = Plus