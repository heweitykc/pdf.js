...
pdfjs-editor-stamp-add-sign-button-label = Signaturu pśidaś
pdfjs-editor-stamp-add-watermark-button-label = Wódowe znamje pśidaś
pdfjs-editor-stamp-add-signature-button-label = Nowu signaturu pśidaś
