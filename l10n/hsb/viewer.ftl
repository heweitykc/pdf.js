...
pdfjs-editor-stamp-add-sign-button-label = Signaturu přidać
pdfjs-editor-stamp-add-watermark-button-label = Wodowe znamjo přidać
pdfjs-editor-stamp-add-signature-button-label = Signaturu přidać
