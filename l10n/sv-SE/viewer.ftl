...
pdfjs-editor-stamp-add-sign-button-label = Lägg till signatur
pdfjs-editor-stamp-add-watermark-button-label = Lägg till vattenstämpel
pdfjs-editor-stamp-add-signature-button-label = Lägg till ny signatur
