...
pdfjs-editor-stamp-add-sign-button-label = Προσθήκη υπογραφής
pdfjs-editor-stamp-add-watermark-button-label = Προσθήκη υδατογραφήματος
pdfjs-editor-stamp-add-signature-button-label = Προσθήκη νέας υπογραφής
